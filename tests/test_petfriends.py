...
def test_add_new_pet_with_valid_data(name='ПетНейм', animal_type='кролик', age='3', pet_photo='image/rabbit.jpg'):
...
def test_add_new_pet_with_non_valid_key(name='ПетНейм', animal_type='кролик', age='3', pet_photo='image/rabbit.jpg'):
...
def test_add_new_pet_with_empty_data(name='', animal_type='', age='', pet_photo='image/donkey.jpg'):
...
def test_add_new_pet_with_valid_data_no_foto(name='ПетНейм', animal_type='кролик', age='3'):
...
def test_add_foto_pet_with_valid_data(pet_photo='image/donkey.jpg'):
    ...
    if len(my_pets['pets']) == 0:
        pf.post_add_new_pet(auth_key, 'Осёл', 'Ослик', '9')
        _, my_pets = pf.get_list_of_pets(auth_key, 'my_pets')
...
def test_successful_delete_self_pet():
    ...
    if len(my_pets['pets']) == 0:
        pf.post_add_new_pet(auth_key, 'Осёл', 'Ослик', '9', 'image/donkey.jpg')
        _, my_pets = pf.get_list_of_pets(auth_key, 'my_pets')
...
def test_successful_update_self_pet_info(name='ДогНейм', animal_type='двортерьер', age=6):
    ...
    if len(my_pets['pets']) > 0:
        ...
        pf.post_add_new_pet(auth_key, 'ПетНейм', 'Кролик', '3', 'image/rabbit.jpg')
        _, my_pets = pf.get_list_of_pets(auth_key, 'my_pets')
        status, result = pf.put_update_pet_info(auth_key, my_pets['pets'][0]['id'], name, animal_type, age)
...
def test_update_pet_info_non_correct_key(name='ДогНейм', animal_type='двортерьер', age=6):
